...
function ProductCard() {
  return (
    <div className='flex flex-col items-center p-5 cursor-pointer border-solid border-2 rounded-lg border-lightYellow transition-all hover:border-brown hover:bg-[#e8e6b3]'>
