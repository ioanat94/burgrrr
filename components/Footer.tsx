...
function Footer() {
  return (
    <>
      ...
      <div className='flex flex-col gap-4 items-center px-12 pt-4 pb-8 bg-black text-lightYellow text-center md:flex-row md:pt-8'>
        <div>
          <Image src='/assets/logo.png' alt='' width='170' height='170' />
        </div>
        <div className='flex flex-col gap-12 items-center justify-evenly w-full md:flex-row md:flex-wrap md:gap-20'>
